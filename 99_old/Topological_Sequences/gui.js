...
function init_GUI()
{
  ...
  //check_print_edges = createCheckbox('Print detailed result', false);

  check_result = createCheckbox('Print detailed result', true);
  //sel_circle_detect = createSelect();
  //sel_circle_detect.option('loop');
  //sel_circle_detect.option('union');
  btn_convert = createButton('Convert Adjacent Matrix to List');
  btn_order_sequence = createButton('Topological Order Sequence');
  ...
  btn_convert.mouseClicked(convert2list)
  btn_order_sequence.mouseClicked(order_sorting)
  ...
  check_result.position(check_echo_print_G.x,check_echo_print_G.y+check_echo_print_G.height)
  //sel_circle_detect.position(check_result.x,check_result.y+check_result.height)
  btn_convert.position(check_result.x,check_result.y+check_result.height)
  btn_order_sequence.position(btn_convert.x,btn_convert.y+btn_convert.height)
